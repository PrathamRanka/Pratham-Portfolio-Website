...
### Creating a Custom Page (e.g., Pratham Page)

If you want a page accessible at:

_http://localhost:3000/pratham_

Follow the same steps as above:

1. Inside _src/app_, create a folder named _pratham_.
2. Inside _pratham_, create a _page.tsx_ file.
3. Add the following code:

```tsx
export default function Pratham() {
  return <h1>Hello from Pratham</h1>;
}
```
