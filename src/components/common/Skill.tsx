...
export default function Skill({ name, href, children, index = 0 }: SkillProps) {
  return (
    <Link
      ...
      className="animate-float skill-inner-shadow inline-flex items-center self-end rounded-full border border-dashed border-black/20 bg-black/5 px-3 py-1.5 text-sm text-black backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:bg-black/10 hover:shadow-lg dark:border-white/20 dark:bg-white/10 dark:text-white dark:hover:bg-white/20"
    >
